...
export function TopPicks({ initialProducts }: { initialProducts?: Product[] }) {
  const { topPicks, isLoading, hasCachedData, mutate } = useTopPicks({ fallbackData: initialProducts })
