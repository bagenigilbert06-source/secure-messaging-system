...
export function FlashSales({ initialProducts }: InitialProductsProps) {
  const { flashSales, isLoading, isError, mutate, hasCachedData } = useFlashSales(initialProducts ? { fallbackData: initialProducts } : undefined)
