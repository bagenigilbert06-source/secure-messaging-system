...
export function NewArrivals({ initialProducts }: InitialProductsProps) {
  const { newArrivals, isLoading, hasCachedData, mutate } = useNewArrivals(initialProducts ? { fallbackData: initialProducts } : undefined)
