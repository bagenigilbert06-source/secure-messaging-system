...
export function DailyFinds({ initialProducts }: { initialProducts?: Product[] }) {
  const { dailyFinds, isLoading, hasCachedData, mutate } = useDailyFinds({ fallbackData: initialProducts })
