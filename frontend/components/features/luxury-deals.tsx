...
export function LuxuryDeals({ initialProducts }: { initialProducts?: Product[] }) {
  const { luxuryDeals, isLoading, isError, mutate, hasCachedData } = useLuxuryDeals({ fallbackData: initialProducts })
