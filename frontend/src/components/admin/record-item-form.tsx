...
export default function RecordItemForm({ onSuccess }: RecordItemFormProps) {
  ...
  return (
    ...
    >
      {/* Header */}
      <div>
        <h2 className="text-2xl font-semibold text-white">Record New Item</h2>
        <p className="text-white/60 text-sm mt-1">Add a lost and found item to the system</p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        >
          ...
          <div>
            <label className="block text-sm font-medium text-white mb-2">Location Stored</label>
            <input
              type="text"
        ...
        <motion.div
          ...
          className="border border-white/10 rounded-lg p-6 space-y-4"
        >
          <h3 className="text-sm font-semibold text-white/80 uppercase tracking-wide mb-4">Images</h3>
